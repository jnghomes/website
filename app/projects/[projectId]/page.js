...
function page() {
  return (
    <>
      <div className="w-screen h-screen bg-primaryAccent"></div>
      <div className="w-full px-8 md:px-0 md:max-w-[80vw] mx-auto">
        <div className="flex flex-col lg:flex-row gap-4 lg:gap-16 mt-4">
          ...
          <p className="text-sm/relaxed text-gray-500 text-justify lg:w-3/5">
            ...
            alias ipsam modi ipsum eos assumenda dolorum, nemo ea ullam
            doloribus mollitia reprehenderit inventore porro. Doloremque nobis
            dolore officia expedita tenetur?
          </p>
        </div>
